    ...
    <div class="m-popup">
      <div class="m-popup-body">
        <div class="popup-content flex">
          <!-- POPUP XÁC NHẬN -->
          <div class="flex" v-if="this.type == ENUM.popupEnum.confirm">
            <div class="m-icon icon--avatar-48 icon--confirm-exclamation"></div>
          </div>
          <!-- POPUP CẢNH BÁO -->
          <div class="flex" v-else-if="this.type == ENUM.popupEnum.warning">
            <div class="m-icon icon--avatar-48 icon--confirm-exclamation"></div>
          </div>
          <!-- POPUP BÁO LỖI -->
          <div class="flex" v-else-if="this.type == ENUM.popupEnum.alert">
            <div class="m-icon icon--avatar-48 icon--alert-exclamation"></div>
          </div>
          <!-- POPUP HIỆN KHI ĐÓNG FORM -->
          <div class="flex" v-else-if="this.type == ENUM.popupEnum.question || this.type == ENUM.popupEnum.info">
        ...
        <div class="m-popup-footer">
          ...
          <div
            ...
            v-if="this.type == ENUM.popupEnum.confirm"
          >
            <button
          ...
          <div
            ...
            v-else-if="this.type == ENUM.popupEnum.warning || this.type == ENUM.popupEnum.info"
          >
            <button
              class="m-btn btn-size-default m-btn-primary"
              @click="closePopup"
          ...
          <div
            ...
            v-else-if="this.type == ENUM.popupEnum.alert"
          >
            <button
              class="m-btn btn-size-default m-btn-primary"
              @click="closePopup"
          ...
          <!-- POPUP HIỆN KHI ĐÓNG FORM -->
          <div class="flex" v-else-if="this.type == ENUM.popupEnum.question">
            <button
              class="m-btn btn-size-default m-btn-secondary"
              @click="closePopup"
            >
